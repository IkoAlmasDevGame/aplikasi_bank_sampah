    ...
    <div class="panel panel-default container-fluid bg-body-secondary rounded-2">
        <div class="panel-heading py-4 container-fluid">
            ...
            <div class="d-flex justify-content-end align-items-end flex-wrap">
                ...
                <li class="breadcrumb breadcrumb-item">
                    <a href="?page=setting&idSetting=1" aria-current="page"
                            ...
                            <div class="col-sm-7 col-md-7">
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body my-2">
                                        <?php if (isset($_GET['idSetting'])): ?>
                                            <?php $SQL = "SELECT * FROM setting WHERE idSetting = '$_GET[idSetting]'"; ?>
                                            <?php $res = $koneksi->query($SQL); ?>
                                            <?php foreach ($res as $data): ?>
                                                <form action="?aksi=profile-website" method="post" class="form-group">
                                                    <input type="hidden" name="idSetting" value="<?= $data['idSetting'] ?>">

    ...
    <div class="panel panel-default container-fluid bg-body-secondary rounded-2">
        <div class="panel-heading py-4 container-fluid">
            ...
            <div class="d-flex justify-content-end align-items-end flex-wrap">
                ...
                <li class="breadcrumb breadcrumb-item">
                    <a href="?page=user-profile&idUser =<?= $_GET['idUser'] ?>" aria-current="page"
                    ...
                    <div class="p-1 p-lg-1 m-1 m-lg-1">
                        ...
                        <div class="d-flex justify-content-center align-items-center flex-wrap">
                            <?php if (isset($_GET['idUser'])) : ?>
                                ...
                                <?php $dataUser = $koneksi->query("SELECT * FROM users WHERE idUser = '$id'"); ?>
                                <?php foreach ($dataUser as $row) { ?>
                                    <div class="card col-sm-7 col-md-7 mb-3">
                                        <div class="card-header py-2">
                                            <h4 class="card-title fs-4 display-4 text-dark">
                                                <?php echo "<div class='display-2 fs-2  fst-times text-center'>Data Profile : $row[namaUser]</div><br"; ?>
                                            </h4>
                                        </div>
                                                ...
                                                <?php foreach ($dataUser as $data) { ?>
                                                    <form action="?aksi=edit-biodata" enctype="multipart/form-data"
                                                        ...
                                                        <div class="form-inline my-2">
                                                            <div class="row justify-content-center align-items-center flex-wrap">
                                                                <div class="form-label col-sm-4 col-md-4 fs-5 display-4 fst-times">
                                                                    <label for="" class="label label-default">Nomor Induk
                                                                        Kependudukan</label>
                                                                </div>
                                                                <div class="col-sm-1 col-md-1">:</div>
                                                                <div class="col-sm-6 col-md-6">
                                                        ...
                                                        <div class="form-inline my-2">
                                                            <div class="row justify-content-center align-items-start flex-wrap">
                                                                ...
                                                                <div class="col-sm-1 col-md-1">:</div>
                                                                <div class="col-sm-6 col-md-6">
                                                                    <textarea name="alamat" id="" rows="3"
                                                            ...
                                                            <div class="row justify-content-center align-items-start flex-wrap">
                                                                ...
                                                                <div class="col-sm-6 col-md-6">
                                                                    <input type="tel" name="telepon"
                                                                        value="<?php echo $data['telepon'] ?>" id=""
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-inline my-2">
                                                            <div class="row justify-content-center align-items-start flex-wrap">
                                                                <div class="form-label col-sm-4 col-md-4 fs-5 display-4 fst-times">
                                                                    <label for="" class="label label-default">Jumlah Setoran</label>
                                                                </div>
                                                                <div class="col-sm-1 col-md-1">:</div>
                                                                <div class="col-sm-6 col-md-6">
                                                                    <input type="text" inputmode="numeric" name="jmlSetoran"
                                                                        value="<?php echo $data['jmlSetoran'] ?>" id=""
                                                        ...
                                                        <div class="form-inline my-2">
                                                            <div class="row justify-content-center align-items-start flex-wrap">
                                                                <div class="form-label col-sm-4 col-md-4 fs-5 display-4 fst-times">
                                                                    <label for="" class="label label-default">Jumlah
                                                                        Penarikan</label>
                                                                </div>
                                                                <div class="col-sm-1 col-md-1">:</div>
                                                                <div class="col-sm-6 col-md-6">
                                                                    <input type="text" inputmode="numeric" name="jmlPenarikan"
                                                                        value="<?php echo $data['jmlPenarikan'] ?>" id=""
                                                                        class="form-control" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-inline my-2">
                                                            <div class="row justify-content-center align-items-start flex-wrap">
                                                                <div class="form-label col-sm-4 col-md-4 fs-5 display-4 fst-times">
                                                                    <label for="" class="label label-default">Saldo</label>
                                                                </div>
                                                                <div class="col-sm-1 col-md-1">:</div>
                                                                <div class="col-sm-6 col-md-6">
                                                                    <input type="text" name="saldo" readonly
                                                                        value="<?= $data['saldo'] ?>" class="form-control" id="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-inline my-2">
                                                        ...
                                                        <?php if (isset($_GET['data'])) { ?>
                                                            <div class="card-footer">
                                                                <div class="text-start">
                                                                    ...
                                                                    <a href="?page=user-profile&idUser=<?= $data['idUser'] ?>"
                                            ...
                                            <?php } elseif (isset($_GET['change'])) { ?>
                                                <?php foreach ($dataUser as $isi): ?>
                                                    <form action="?aksi=edit-password" class="form-group" method="post">
                                                        <input type="hidden" name="idUser" value="<?= $isi['idUser'] ?>">
                                                        <div class="form-inline my-2">
                                                            <div class="row justify-content-center align-items-center flex-wrap">
                                                                <div class="form-label col-sm-4 col-md-4 fs-5 display-4 fst-times">
                                                        ...
                                                        <?php if (isset($_GET['change'])): ?>
                                                            <div class="card-footer">
                                                                <div class="text-start">
                                                                    ...
                                                                    <a href="?page=user-profile&idUser=<?= $isi['idUser'] ?>"
                                                                        aria-current="page" class="btn btn-danger">
                                                                        <i class="fas fa-fw fa-close"></i>
                                                                        Cancel
                                                                    </a>
                                    ...
                                    <?php } else { ?>
                                        <div class="form-inline my-2">
                                            <div class="row justify-content-center align-items-center flex-wrap">
                                                <div class="form-label col-sm-4 col-md-4 fs-5 display-4 fst-times">
                                                    <label for="" class="label label-default">ID USER</label>
                                                </div>
                                                <div class="col-sm-1 col-md-1">:</div>
                                                <div class="col-sm-6 col-md-6">
                                                    <input type="text" class="form-control" name="idUser"
                                                        value="<?= $row['idUser'] ?>" id="" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-inline my-2">
                                            <div class="row justify-content-center align-items-center flex-wrap">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <input type="text" class="form-control" name="namaUser"
                                                        value="<?= $row['namaUser'] ?>" id="" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-inline my-2">
                                        ...
                                        <div class="form-inline my-2">
                                            <div class="row justify-content-center align-items-start flex-wrap">
                                                ...
                                                <div class="col-sm-1 col-md-1">:</div>
                                                <div class="col-sm-6 col-md-6">
                                                    <textarea name="alamat" id="" rows="3" readonly
                                        ...
                                        <div class="form-inline my-2">
                                            <div class="row justify-content-center align-items-start flex-wrap">
                                                ...
                                                <div class="col-sm-1 col-md-1">:</div>
                                                <div class="col-sm-6 col-md-6">
                                                    <input type="tel" name="telepon" value="<?php echo $row['telepon'] ?>"
                                        ...
                                        <div class="form-inline my-2">
                                            <div class="row justify-content-center align-items-start flex-wrap">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <input type="text" inputmode="numeric" name="jmlSetoran"
                                                        value="<?php echo $row['jmlSetoran'] ?>" id="" class="form-control"
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-inline my-2">
                                            <div class="row justify-content-center align-items-start flex-wrap">
                                                <div class="form-label col-sm-4 col-md-4 fs-5 display-4 fst-times">
                                                    <label for="" class="label label-default">Jumlah Penarikan</label>
                                                </div>
                                                <div class="col-sm-1 col-md-1">:</div>
                                                <div class="col-sm-6 col-md-6">
                                                    <input type="text" inputmode="numeric" name="jmlPenarikan"
                                                        value="<?php echo $row['jmlPenarikan'] ?>" id=""
                                                        class="form-control" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-footer my-2">
                                            <div class="text-start">
                                                <a href="?page=user-profile&idUser=<?= $row['idUser'] ?>&data=<?= $row['idUser'] ?>"
                                                    aria-current="page" class="btn btn-success">
                                                    <i class="fas fa-fw fa-edit"></i>
                                                    Edit
                                                </a>
                                                <a href="?page=user-profile&idUser=<?= $row['idUser'] ?>&change=<?= $row['idUser'] ?>"
                                                    aria-current="page" class="btn btn-danger">

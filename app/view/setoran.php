...
<head>
    ...
    <title><?php echo $setting['nama'] . " Setoran" ?></title>
    ...
    <link rel="stylesheet" href="<?php echo base_url('dist/css/style-schedule.css') ?>">
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="title-un-des">Berikut merupakan jenis sampah yang dapat disetorkan berdasarkan
                            harinya, jadwal penyetoran dapat dilakukan pada hari senin - sabtu (hari minggu libur).
                        </p>
                        <!-- start css -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md col-md-12">
                        ...
                        <p class="title-un-des" style="text-align: center;">
                            Berikut adalah rincian dari setoran penggona
                        </p>
                        <table id="datatable2" class="table table-striped-columns table-bordered">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php $i = 1; ?>
                                <?php $setoran = query("SELECT * FROM setoran ORDER BY idSetor ASC"); ?>
                                <?php foreach ($setoran as $row) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center fw-normal"><?php echo $row['tglSetor'] ?></td>
                                        <?php foreach ($namaUser as $user) : ?>
                                            <td class="text-center fw-normal"><?php echo $user['namaUser']; ?></td>
                                        <?php endforeach; ?>
                                        <?php foreach ($namaSampah as $sampah) : ?>
                                            <td class="text-center fw-normal"><?php echo $sampah['namaSampah']; ?></td>
                                            <td class="text-center fw-normal"><?php echo $row['berat'] . " KG" ?></td>
        ...
        <footer class="footer-distributed">
            ...
            <div class="footer-right">
                ...
                <p class="footer-company-about">
                    ...
                    Untuk yang ingin lebih dekat dengan Bank Sampah Apa Saja, silahkan kunjungi sosial
                    media kami
                    dibawah ini!
                </p>
    ...
    <script crossorigin="anonymous" src="https://cdn.datatables.net/1.13.7/js/dataTables.bootstrap5.min.js">
    </script>
</body>
